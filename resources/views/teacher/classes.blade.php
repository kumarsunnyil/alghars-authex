                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div id="external-events">
                                            ...
                                            {{-- {{ $dates = $data['classDates']}} --}}

                                                <div class="external-event bg-success"> Test Program </div>
                                            {{-- <div class="external-event bg-warning">Go home</div> --}}
                                            {{-- <div class="external-event bg-info">Do homework</div> --}}
                                            <div class="external-event bg-primary">Class On Work with UI design</div>
